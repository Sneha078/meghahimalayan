...
// Online payment -> Paid
// COD -> Delivered
// Cancelled/deleted/refunded orders are excluded
const REVENUE_MATCH = {
  isDeleted: false,
...
export const getDashboardStats = handleAsyncError(
  async (req, res, next) => {
    const [counts, orderStats, categoryStats] =
      await Promise.all([
        Promise.all([
...
export const getAnalytics = handleAsyncError(
  async (req, res, next) => {
...
export const getTopCustomers = handleAsyncError(
  async (req, res, next) => {
