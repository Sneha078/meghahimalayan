  ...
  return (
    <div style={{ backgroundColor: 'var(--color-sbg)', minHeight: '100vh' }}>
      ...
      <div style={{ padding: '3rem 5rem', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', maxWidth: '1400px', margin: '0 auto' }}>
        ...
        {/* Thumbnails removed — will be added when real product images are available */}
      ...
      <div style={{ padding: '0 5rem', maxWidth: '1400px', margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: '3rem', padding: '0 0.5rem' }}>
          ...
          {activeTab === 'reviews' && (
            <div style={{ maxWidth: '700px' }}>
              {[
                { name: 'Priya S.',  rating: 5, comment: 'Absolutely love this product. The quality is outstanding and it looks even better in person.' },
                { name: 'Rohan M.', rating: 4, comment: 'Great product for the price. Fast delivery from Mega Himalaya. Will buy again.' },
                { name: 'Anisha T.',rating: 5, comment: 'Premium quality. Exactly as described. Highly recommend.' },
              ].map((review, i) => (
                <div key={i} style={{ padding: '1.25rem 0', borderBottom: '1px solid var(--color-border)' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.5rem' }}>
                    <div style={{ width: '36px', height: '36px', borderRadius: '50%', backgroundColor: 'var(--color-navy)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--color-taupe)', fontSize: '0.82rem', fontWeight: '700' }}>
                      {review.name[0]}
                    </div>
                    <div>
                  ...
                  <p style={{ fontSize: '0.88rem', color: 'var(--color-muted)', lineHeight: '1.7', textAlign: 'justify' }}>{review.comment}</p>
                </div>
              ))}
            </div>
          )}
      ...
      {relatedProducts.length > 0 && (
        <div style={{ padding: '2rem 5rem 4rem', maxWidth: '1400px', margin: '0 auto' }}>
          <div style={{ marginBottom: '2rem' }}>
            <p style={{ color: 'var(--color-taupe)', fontSize: '0.85rem', fontWeight: '800', letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: '0.5rem' }}>
              YOU MAY ALSO LIKE
            </p>
