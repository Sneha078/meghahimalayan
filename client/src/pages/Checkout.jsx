            ...
            { currentStep === 0 && (
                ...
                <div>
                 ...
                 <div>
                  ...
                  {errors.province && <p style={errorStyle}>{errors.province}</p>}
                </div>
            ...
            { currentStep === 1 && (
                <div >
                    ...
                    <div style={{display: 'flex', flexDirection: 'column', gap: '16px'}}>
                        ...
                        padding: '20px 24px',
                        borderRadius: '12px',
                        border: `2px solid ${paymentMethod === 'cod'
                         ? 'var(--color-navy)'
                        : 'var(--color-border)'}`,
                        cursor: 'pointer',
...
/>
            ...
            { currentStep === 2 && (
                ...
                <p style={{
                 ...
                 Delivering To   </p>   
                  <p style={{ fontWeight: '600', color: 'var(--color-navy)', marginBottom: '4px' }}>
                  {form.fullName}
                </p>
                <p style={{ fontSize: '0.85rem', color: 'var(--color-muted)', marginBottom: '2px' }}>
               ...
               <div style={{
                ...
                <p style={{ fontWeight: '600', color: 'var(--color-navy)' }}>
                  💵 Cash on Delivery
                </p>
              </div>  
                ...
                {cartItems.map((item) => (
                  <div key={item.id} style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                      ...
                      <div>
                        <p style={{ fontSize: '0.85rem', fontWeight: '600', color: 'var(--color-navy)' }}>
                          {item.name}
                        </p>
        ...
        <div style={{
         ...
         {cartItems.map((item) => (
          ...
          <div>
                  <p style={{ fontSize: '0.78rem', fontWeight: '600', color: 'var(--color-navy)' }}>
                    {item.name}
                  </p>
        ...
        <div style={{ borderTop: '1px solid var(--color-border)', margin: '16px 0' }} />
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '16px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ fontSize: '0.85rem', color: 'var(--color-muted)' }}>Subtotal</span>
              <span style={{ fontSize: '0.85rem', fontWeight: '600', color: 'var(--color-navy)' }}>
                Rs. {subtotal.toLocaleString()}
              </span>
            </div>
          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ fontSize: '0.85rem', color: 'var(--color-muted)' }}>Shipping</span>
              <span style={{
                fontSize: '0.85rem',
                fontWeight: '600',
                color: shipping === 0 ? '#15803D' : 'var(--color-navy)',
              }}>
